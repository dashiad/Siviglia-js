...
<script>
    ...
    if (!urlParams.has("test")) {
        DEVELOP_MODE=45;    // Specific test number
                           ...
                           "VALUETYPE" => [
                               ...
                               "ALLOWED_TYPES" => [
                                   ...
                                   "RelationMxN" => [
                                       ...
                                       "RELATIONS_ARE_UNIQUE"=>["LABEL"=>"Relaciones unicas","TYPE"=>"Boolean","DEFAULT"=>false],
                                       "CARDINALITY"=>["LABEL"=>"Cardinalidad","TYPE"=>"Integer"],
                                       "KEEP_KEY_ON_EMPTY" => ["LABEL" => "Permitir valor vacío", "TYPE" => "Boolean", "KEEP_KEY_ON_EMPTY" => false],
                                       "REQUIRED" => ["TYPE" => "Boolean", "DEFAULT" => false, "LABEL" => "Requerido", "KEEP_KEY_ON_EMPTY" => false],
                                       "DEFAULT" => ["TYPE" => "String", "LABEL" => "Valor por defecto", "KEEP_KEY_ON_EMPTY" => false]
                                           ]
