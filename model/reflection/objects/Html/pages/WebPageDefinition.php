<?php
  ...
  abstract class WebPageDefinition extends \model\reflection\base\BaseDefinition
  {
      ...
      function initialize($name,$srcObject,$definition)
      {
          ...
          $this->filePath=WEBROOT."/Website/".$admin.$parentClassName."/".$this->srcObject->getName().".php";
      ...
      function setupPath()
      {
          ...
          foreach($probableKeys as $key=>$value)
          {
              ...
              $modelDef=\model\reflection\ReflectorFactory::getModel($key);
      ...
      {
              $model=\model\reflection\ReflectorFactory::getModel($modelName);
      ...
      function getBelongsToNamespaceField($model)
      {
          ...
          $publicModel=\model\reflection\ReflectorFactory::getModel($publicModelName);
