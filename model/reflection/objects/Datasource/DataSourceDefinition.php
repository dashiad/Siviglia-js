...
*/
class DataSourceDefinition extends \model\reflection\base\ConfiguredObject
{       
    ...
    {        
        ...
        $this->permissions=new \model\reflection\Permissions\PermissionRequirementsDefinition($definition["PERMISSIONS"]?$definition["PERMISSIONS"]:"_PUBLIC_");
        $this->includes=array();
