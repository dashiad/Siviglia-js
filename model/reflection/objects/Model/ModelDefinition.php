...
class ModelDefinition extends \model\reflection\base\SimpleModelDefinition
{
    var $aliases=array();
    var $actions=array();
     ...
     *    Function : getDefinition()
       */
        ...
        function loadDataSources()
        {
            ...
            foreach($dsnames as $curDs)
            {
                ...
                if(is_a($instance,'\lib\datasource\MultipleDataSource'))
                    continue;
                $this->datasources[$curDs]=new \model\reflection\Datasource\DataSourceDefinition($curDs,$this);
        ...
        function loadActions()
        {
            ...
            {                
                $this->actions[$curAct]=new \model\reflection\Action\ActionDefinition($curAct,$this);
