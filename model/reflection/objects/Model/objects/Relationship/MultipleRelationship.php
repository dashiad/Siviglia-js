  ...
  class MultipleRelationship extends  \model\reflection\Model\Alias\AliasDefinition
  {
      ...
      var $relationsAreUnique;
       ...
       static function createFromRelationship($name,$relationshipName,$relationshipObj,$sourceObj)
       {
           ...
           $def["MODEL"]=$relationshipObj->objectName->getNormalizedName();
       ...
       function getRelationTableRemoteFields()
       {
        ...
        {
            return \model\reflection\ReflectorFactory::getModel($this->definition["REMOTE_MODEL"]);
        }
            ...
            $remoteModel= $this->getRemoteInstance();
             ...
             {              
                ...
                if($role=="DeleteRelation")
                {
                    ...
                    $remoteModel=\model\reflection\ReflectorFactory::getModel($this->getRelationModelName());
        ...
        function generateActions($isAdmin)
        {
            ...
            $targetModel=\model\reflection\ReflectorFactory::getModel($targetModelName);
      ...
      function getDataSources($targetModel=null,$baseName=null)
      {
          ...
          $targetModel=\model\reflection\ReflectorFactory::getModel($this->definition["MODEL"]);
