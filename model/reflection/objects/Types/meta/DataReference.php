...
class DataReference extends \model\reflection\Meta\BaseMetadata{
    ...
    {
        if(is_a($value,'\model\reflection\Types\meta\ArrayType'))
        {
            ...
            throw new DataReferenceException(DataReferenceException::ERR_CANT_FIND_REFERENCE,
        ...
        else
        {
            ...
            else
            {
                ...
                $type=\model\reflection\Types\meta\TypeFactory::getFieldTypeInstance($this->refModel,$this->refField);
    ...
    function getRequiredDsField($value)
    {
        ...
        {
            if(\model\reflection\Types\meta\TypeFactory::isSameField($val,$this->refModel,$this->refField))
                return $key;
        }
        return null;
    }
