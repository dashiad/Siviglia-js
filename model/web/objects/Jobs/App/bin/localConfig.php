...
define("PROJECTPATH", dirname(__DIR__, 6).\DIRECTORY_SEPARATOR);
...
$Config=[
    ...
    "SERIALIZERS"=>array(
        "default"=>array("NAME"=>"default","TYPE"=>"Mysql","ADDRESS"=>array("host"=>"services.net1.hadoop.oraclevcn.com","user"=>"adtopy","password"=>"adtopy","database"=>"adtopy")),
        "web"=>array("NAME"=>"web","TYPE"=>"Mysql","ADDRESS"=>array("host"=>"services.net1.hadoop.oraclevcn.com","user"=>"adtopy","password"=>"adtopy","database"=>"adtopy")),
