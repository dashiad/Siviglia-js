        define(
            ["dojo/_base/declare",
                "dojo/text!web//objects/model/objects/Page/dojo/views/templates/AdminFullList.html", "Siviglia/lists/DataSourceView","dojo/when", "dojo/Deferred", "dojo/dom-construct", "dojo/on","dijit/form/Select",
            ...
            return declare('.model.Page.AdminFullList', [DataSourceView],
            {
                templateString:template,
                modelName:'\\model\\Page',
                datasource:'AdminFullList',
                inputMappings:[],
                fieldDefinition:{"id_page":{"name":"id_page","display":true,"order":0,"label":"[@L]id_page[#]"},"tag":{"name":"tag","display":true,"order":1,"label":"[@L]tag[#]"},"name":{"name":"name","display":true,"order":2,"label":"[@L]name[#]"},"date_add":{"name":"date_add","display":true,"order":3,"label":"[@L]date_add[#]"},"date_modified":{"name":"date_modified","display":true,"order":4,"label":"[@L]date_modified[#]"},"id_type":{"name":"id_type","display":true,"order":5,"label":"[@L]id_type[#]"},"isPrivate":{"name":"isPrivate","display":true,"order":6,"label":"[@L]isPrivate[#]"},"path":{"name":"path","display":true,"order":7,"label":"[@L]path[#]"},"title":{"name":"title","display":true,"order":8,"label":"[@L]title[#]"},"tags":{"name":"tags","display":true,"order":9,"label":"[@L]tags[#]"},"description":{"name":"description","display":true,"order":10,"label":"[@L]description[#]"}},
                groupable:[],
                addable:[],
