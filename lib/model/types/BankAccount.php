...
class BankAccount extends _String
{
    ...
    function validateCCC($ccc)
    {
        ...
        {
            throw new BankAccountException(BankAccountException::ERR_INVALID_CCC,["ccc"=>$ccc],$this);
        }
    ...
    function validateIBAN($iban)
    {
        ...
        if(strlen($iban) == $Countries[substr($iban,0,2)]){
            ...
            if(bcmod($NewString, '97') == 1)
            {
                ...
                throw new BankAccountException(BankAccountException::ERR_INVALID_IBAN,["iban"=>$iban],$this);
            }
        }
        else{
            throw new BankAccountException(BankAccountException::ERR_INVALID_IBAN,["iban"=>$iban],$this);
