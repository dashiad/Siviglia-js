	...
	public static function dump($data)
	{
		...
		while ( $callee = array_pop( $trace ) ) {
			...
			if ( strtolower( $callee['function'] ) === 'd' ||
                 ...
                 strtolower( $callee['function'] ) === strtolower( "Debug" ) ||
                                strtolower( $callee['function'] ) === strtolower( "debug_plain" ) ||
                                strtolower( $callee['function'] ) === strtolower( "_d" )
			) {
				break;
			} else {
				$prevCaller = $callee;
