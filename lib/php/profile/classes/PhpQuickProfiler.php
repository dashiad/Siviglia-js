...
class PhpQuickProfiler {
	...
	public function __construct($startTime, $config = '/pqp/',$urlConfig) {
	...
	public function gatherSpeedData() {
		$speedTotals = array();
		$speedTotals['total'] = $this->getReadableTime((PhpQuickProfiler::getMicroTime() - $this->startTime)*1000);
	...
	public function display($db = '', $master_db = '') {
		...
		displayPqp($this->output, $this->urlConfig);
	}
