<?php
  ...
  class Relationship extends  \lib\reflection\base\AliasDefinition
  {
      ...
      var $relationsAreUnique;
       ...
       function getRelationTableRemoteFields()
       {
        ...
        {            
            ...
            $objDef=new \lib\reflection\model\ObjectDefinition($this->definition["MODEL"]);
        ...
        function parseFromModel()
        {
            ...
            $relObject=\lib\reflection\ReflectorFactory::getModel($def["MODEL"]);
      ...
      function getDataSources($targetModel=null,$baseName=null)
      {
          ...
          $targetModel=\lib\reflection\ReflectorFactory::getModel($this->definition["MODEL"]);
