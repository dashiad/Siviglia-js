...
class RelationshipDefinition extends \lib\reflection\model\BaseRelation
{
    ...
    function getDefaultInputParams($form=null,$actField=null)
    {
        ...
        {
            $datasource=array("NAME"=>"FullList","MODEL"=>$targetModel->objectName->getNormalizedName());
        }
        ...
        $labelFields=array();
        $datasourceModelName=new \lib\reflection\model\ObjectDefinition($datasource["MODEL"]);
    ...
    function isDescriptive() {
        return isset($this->definition["DESCRIPTIVE"]) &&  $this->definition["DESCRIPTIVE"] == true;
    }
    ...
    function isLabel() {
        return isset($this->definition["ISLABEL"]) && $this->definition["ISLABEL"] == true;
    }
    ...
    function getType()
    {
        $targetObject=\lib\reflection\ReflectorFactory::getModel($this->definition["MODEL"]);
