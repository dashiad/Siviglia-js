...
class ParametrizableStringTest extends TestCase {
    ...
    {
        $this->expectException('\lib\php\ParametrizableStringException');
        $this->expectExceptionCode(ParametrizableStringException::ERR_MISSING_REQUIRED_PARAM);
        $cad4="[%/hh%] [%/bb%]";
    ...
    function testNotDefinedVariable()
    {
        ...
        $this->expectExceptionCode(ParametrizableStringException::ERR_MISSING_REQUIRED_VALUE);
