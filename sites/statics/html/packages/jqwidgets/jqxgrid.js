        ...
        defineInstance: function () {
            var d = {
                ...
                charting: {
                    ...
                    dialog: {header: "Data Visualization", height: 400, width: 400, position: "center", enabled: true},
                    ready: null,
                    formatSettings: {}
                },
            ...
            if (S >= 0) {
                ...
                for (var n = 0; n < U && ac < U; n++) {
                    ...
                    if (ae != null) {
                        ...
                        this.hittestinfo[this.hittestinfo.length] = {row: ae, visualrow: k, details: false};
                        if (X && w) {
                            ac++;
                            var k = this.table[0].rows[ac];
                            this._renderrowdetails(B, k, ae, an, r, ac);
                            this.visiblerows[this.visiblerows.length] = ae;
                            this.hittestinfo[this.hittestinfo.length] = {row: ae, visualrow: k, details: true}
                        }
                        if (!this.autorowheight) {
                            if (Q + e >= x) {
                                break
