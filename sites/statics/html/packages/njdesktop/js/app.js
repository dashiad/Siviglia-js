...
var nJDSKApp = (function(w,d,$){
	return{
		...
		init: function()
		{
			...
			nJDSK.iconHelper.addIcon('iconTest','About','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIcon','Normal Resizable window','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('iconTest2','About Glassy','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconGlassy','Glassy Resizable window','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			// this icon creates a glassy resizable window (content area is translucent)
			nJDSK.iconHelper.addIcon('resIconFormWindow','Basic HTML Form elements','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconX','Resizable window with toolbar items','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				$.get('xct.html?ver='+nJDSK.uniqid(),function(msg){
					// create window
			...
			nJDSK.iconHelper.addIcon('resIconX1','Text','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconEvents','Window with events','http://statics.adtopy.com/packages/njdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				$.get('xct.html',function(msg){
