!function(o, r, p) {
    ...
    if (p(o).on("load", function() {
            ...
            a.addLiviconEvo({
                ...
                afterAdd: function() {
                    e === p(".main-menu-content .menu-livicon").length - 1 && p(".main-menu-content .nav-item a").on("mouseenter", function() {
                        p(".main-menu-content .menu-livicon").length && (p(".main-menu-content .menu-livicon").stopLiviconEvo(),
        ...
        p('a[data-action="collapse"]').on("click", function(e) {
            e.preventDefault(),
            //p(this).closest(".card").children(".card-content").toggleClass("toggle"),
            p(this).find("card-content collapse").removeClass("show"),
        ...
        p('a[data-action="expand"]').on("click", function(e) {
            e.preventDefault(),
            p(this).closest(".card").find('[data-action="expand"] i').toggleClass("bx-fullscreen bx-exit-fullscreen"),
        ...
        p('.card .heading-elements a[data-action="collapse"]').on("click", function() {
            ...
            0 < parseInt(a[0].style.height, 10) ? (e = a.css("height"),
            a.css("height", "").attr("data-height", e)) : a.data("height") && (e = a.data("height"),
        ...
        "horizontal-menu" == n && (p(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"),
        p(".main-menu-content").find("li.active").parents("li").addClass("active")),
        ...
        p(".char-textarea").on("keyup", function(e) {
            !function(e, a) {
                ...
                t = a,
                8 != t.keyCode && 46 != t.keyCode && 37 != t.keyCode && 38 != t.keyCode && 39 != t.keyCode && 40 != t.keyCode && e.value.length < n - 1 && (e.value = e.value.substring(0, n));
                var t;
                p(".char-count").html(e.value.length),
                e.value.length > n ? (p(".counter-value").css("background-color", u),
                p(".char-textarea").css("color", u),
                p(".char-textarea").addClass("max-limit")) : (p(".counter-value").css("background-color", "#5A8DEE"),
    ...
    "undefined" != typeof Hammer) {
        ...
        if (0 < p(e).length)
            new Hammer(e).on("panright", function(e) {
                if (d.hasClass("vertical-overlay-menu"))
                    return p.app.menu.open(),
                    !1
            });
        setTimeout(function() {
    ...
    p(r).on("click", ".menu-toggle, .modern-nav-toggle", function(e) {
        ...
        0 < p("#collapsed-sidebar").length && setTimeout(function() {
    ...
    "undefined" != typeof screenfull && screenfull.enabled && p(r).on(screenfull.raw.fullscreenchange, function() {
        screenfull.isFullscreen ? (p(".nav-link-expand").find("i").toggleClass("bx-exit-fullscreen bx-fullscreen"),
        p("html").addClass("full-screen")) : (p(".nav-link-expand").find("i").toggleClass("bx-fullscreen bx-exit-fullscreen"),
        p("html").removeClass("full-screen"))
    }),
    p(r).ready(function() {
        p(".step-icon").each(function() {
            var e = p(this);
            0 < e.siblings("span.step").length && (e.siblings("span.step").empty(),
    ...
    p("#sidebar-page-navigation").on("click", "a.nav-link", function(e) {
        ...
        setTimeout(function() {
            a.parent(".nav-item").siblings(".nav-item").children(".nav-link").removeClass("active"),
            a.addClass("active")
        }, 100)
    }),
    ...
    p(".search-input .input").on("keyup", function(e) {
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            27 == e.keyCode && (p(".app-content").removeClass("show-overlay"),
            p(".bookmark-input input").val(""),
            p(".bookmark-input input").blur(),
            p(".search-input input").val(""),
            p(".search-input input").blur(),
            p(".search-input").removeClass("open"),
            p(".search-list").hasClass("show") && (p(this).removeClass("show"),
            p(".search-input").removeClass("show")));
            var s = p(this).val().toLowerCase()
              , o = ""
              , i = !1;
            if (p("ul.search-list li").remove(),
            p(this).parent().hasClass("bookmark-input") && (i = !0),
            "" != s) {
                p(".app-content").addClass("show-overlay"),
                p(".bookmark-input").focus() ? p(".bookmark-input .search-list").addClass("show") : (p(".search-input .search-list").addClass("show"),
                p(".bookmark-input .search-list").removeClass("show")),
                !1 === i && (p(".search-input .search-list").addClass("show"),
                p(".bookmark-input .search-list").removeClass("show"));
                var l = ""
                  , r = ""
                  , c = ""
                ...
                p.getJSON("../../../app-assets/data/" + h + ".json", function(e) {
                    for (var a = 0; a < e.listItems.length; a++) {
                        ...
                        0 == e.listItems[a].name.toLowerCase().indexOf(s) && u < 10 && (l += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === u ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + d + "</a></li>",
                        u++)
                    }
                    for (a = 0; a < e.listItems.length; a++) {
                        if (!0 === i) {
                            o = "";
                            for (n = p("ul.nav.navbar-nav.bookmark-icons li"),
                            t = 0; t < n.length; t++)
                                o = e.listItems[a].name === n[t].firstChild.dataset.originalTitle ? " warning" : "";
                            d = '<span class="float-right bookmark-icon bx bx-star' + o + '"></span>'
                        }
                    ...
                    "" == l && "" == r && (r = '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex justify-content-start"><span class="mr-75 bx bx-error-circle"></span><span>No results found.</span></div></a></li>'),
                    c = l.concat(r),
                    p("ul.search-list").append(c)
                })
            } else if (!0 === i) {
                ...
                p(".app-content").hasClass("show-overlay") && p(".app-content").removeClass("show-overlay"),
                p(".search-list").hasClass("show") && p(".search-list").removeClass("show")
        }
    }),
    ...
    p("html").on("click", function(e) {
        p(e.target).hasClass("bookmark-icon") || (p(".bookmark-input .search-list").hasClass("show") && p(".bookmark-input .search-list").removeClass("show"),
        p(".bookmark-input").hasClass("show") && p(".bookmark-input").removeClass("show"))
    }),
    p(r).on("click", ".bookmark-input .search-list .bookmark-icon", function(e) {
        if (e.stopPropagation(),
        p(this).hasClass("warning")) {
            p(this).removeClass("warning");
            for (var a = p("ul.nav.navbar-nav.bookmark-icons li"), n = 0; n < a.length; n++)
                a[n].firstChild.dataset.originalTitle == p(this).parent()[0].innerText && a[n].remove();
            e.preventDefault()
        } else {
            a = p("ul.nav.navbar-nav.bookmark-icons li");
            p(this).addClass("warning"),
            e.preventDefault();
            var t;
            t = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + p(this).parent()[0].href + '" data-toggle="tooltip" data-placement="top" title="' + p(this).parent()[0].innerText + '"><i class="ficon ' + p(this).parent()[0].firstChild.firstChild.dataset.icon + '"></i></a></li>',
