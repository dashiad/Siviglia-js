...
if ($datasources) {
    ...
    foreach($datasources as $dKey=>$dValue) {
        echo '<li>'.$dKey;
        echo '&nbsp;[<a href="./regenerateDatasource.php?layer='.$layer.'&object='.$obj.'&datasource='.$dKey.'&action=all">Regenerar datasource</a>]';
        echo '&nbsp;[<a href="./regenerateDatasource.php?layer='.$layer.'&object='.$obj.'&datasource='.$dKey.'&action=dojo">Regenerar dojo</a>]';
        echo '&nbsp;[<a href="./regenerateDatasource.php?layer='.$layer.'&object='.$obj.'&datasource='.$dKey.'&action=translations">Regenerar traducciones</a>]';
        echo '</li>';
    }
    echo '<li><a href="./regenerateDatasource.php?layer='.$layer.'&object='.$obj.'&datasource=all&action=all">Regenerar todos los datasources</li>';
}
else {
...
if ($actions) {
    ...
    foreach ($actions as $aKey => $aValue) {
        echo '<li>'.$aKey;
        echo '&nbsp;[<a href="./regenerateAction.php?layer='.$layer.'&object='.$obj.'&action='.$aKey.'&type=all">Regenerar vista</a>]';
        echo '&nbsp;[<a href="./regenerateAction.php?layer='.$layer.'&object='.$obj.'&action='.$aKey.'&type=dojo">Regenerar dojo</a>]</li>';
    }
    echo '<li><a href="./regenerateAction.php?layer='.$layer.'&object='.$obj.'&action=all&type=all">Regenerar todas las actions</li>';
}
else {
