...
if (urlParams.has('name')) {
  ...
  testLoader.src = 'http://statics.adtopy.com/packages/Siviglia/ui/tests/' + urlParams.get('name') + '.js'
  document.getElementsByTagName('title')[0].innerHTML = urlParams.get('name')
